...
function live_set_values() {
    ...
    var num;
     ...
     if ( num_input.value == 1 && time_input.innerHTML == "Hours" || num_input.value == 60 && time_input.innerHTML == "Minutes") {
    ...
    else if (num_input.value == 1 && time_input == "Minutes" || num_input.value == 60 && time_input == "Seconds"){
        refresh_col.forEach(option => {
    ...
    else if (num_input.value >= 5 && num_input.value <= 60 && time_input.innerHTML == "Seconds") {
    ...
    else if (num_input.value >= 1 && num_input.value <= 60 && time_input.innerHTML == "Minutes") {
        
        refresh_col.forEach(option => {
            option.innerHTML = `${num_input.value} ${time_input.innerHTML}`;
        });
        
        num = num_input.value * 600000;
